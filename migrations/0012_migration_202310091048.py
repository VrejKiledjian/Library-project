...
class Student(peewee.Model):
    ...
    borrowed_book = TextField(default='')
    roll = CharField(max_length=255, null=True)
    class Meta:
        table_name = "student"
...
def forward(old_orm, new_orm):
    ...
    return [
        # Apply default value '' to the field student.borrowed_book,
        student.update({student.borrowed_book: ''}).where(student.borrowed_book.is_null(True)),
    ]
